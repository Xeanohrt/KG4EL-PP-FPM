...
CREATE (g:Milestone {Key_Business_Process: 1, Description: "Example"})-[:DIRECTLY_FOLLOWS]->(:Milestone {Key_Business_Process: 2, Description: "Example"}-[:DIRECTLY_FOLLOWS]->(n:Milestone {Key_Business_Process: 3, Description: "Example"}) RETURN g, n